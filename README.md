...
ON NODE TERMINAL
Open terminal on folder project 
run 
npm init -y 
npm i --save express
npm i --save mysql2

On file config.js put your mysql user and password



>>>>>>>>>> DATABASE CONF <<<<<<<<<<<
create a database on local mysql
name like nodeapi_data for example
...
After table created run insert command
